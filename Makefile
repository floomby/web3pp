...
windows-test: tests/encoder.cpp tests/abi.cpp
	g++ $^ -o test -lssl -lcrypto -Wall -pedantic -std=gnu++23 -lboost_random-mt -lboost_program_options-mt -lboost_json-mt -ggdb -fdiagnostics-color -lws2_32 -lwsock32 -lboost_unit_test_framework-mt -lboost_system-mt -fuse-ld=lld
